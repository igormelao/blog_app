...
RSpec.feature "Adding Reviews to Articles" do
  ...
  before do
    ...
    @article = Article.create(title: "First article", body:"body of first", user: @john)
  end

  scenario "Adding Reviews to Article permits a signed in user to write a review" do
    login_as(@fred)
